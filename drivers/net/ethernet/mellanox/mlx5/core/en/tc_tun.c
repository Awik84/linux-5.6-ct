				  ...
				  struct net_device **out_dev)
{
	...
	*route_dev = dev;
	...
	if (!(mlx5e_eswitch_rep(*out_dev) &&
		...
		return -EOPNOTSUPP;
	// remove this limtation since we can forward to other uplink
				    ...
				    struct mlx5e_encap_entry *e)
{
	...
	if (max_encap_size < ipv4_encap_size) {
		mlx5_core_err(priv->mdev, "encap size %d too big, max supported is %d\n",
	...
	/* use the mdev of the output dev since it might be the other pf */
